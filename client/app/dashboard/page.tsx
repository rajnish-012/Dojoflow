...
export default function DashboardPage() {
  ...
  const attendancePercentage =
    dashboard.students.active > 0
      ? (dashboard.attendance.todayPresent / dashboard.students.active) * 100
      : 0;
          ...
          >
            ...
            >
              ...
              <div>
                <p
                  className="
                    text-m font-bold text-(--foreground-soft)
                  "
                >
                  Active students
                </p>
        ...
        <Card padding="none" className="overflow-hidden">
          ...
          {dashboard.recentPerformance.length === 0 ? (
            ...
            <div className="divide-y divide-(--line)">
              {dashboard.recentPerformance.slice(0, 5).map((record) => {
                  ...
                  >
                    ...
                    <div
                      className="
                        ...
                        "
                    >
                      <Badge variant={getRatingVariant(record.rating)}>
                        {record.rating}/5
                      </Badge>
            ...
            >
              ...
              >
                ...
                <span
                  ...
                  "
                >
                  {Math.round(clampPercentage(activeStudentPercentage))}%
                </span>
              </div>
            </div>
