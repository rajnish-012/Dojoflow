...
const benefits = [
  {
    ...
    description:
      "Learn karate through a disciplined and supportive training environment.",
  },
  {
    icon: Clock3,
  ...
  },
  {
    ...
    description:
      "Programs are suitable for beginners, intermediate and advanced students.",
  },
  {
    icon: MapPin,
...
export default function InquiryPage() {
  ...
  const handleSubmit = async (event: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      // Refresh real public data after successful submission.
  ...
  return (
    ...
    >
      ...
      <section className="relative overflow-hidden bg-white">
        ...
        <div className="absolute right-0 top-20 h-96 w-96 rounded-full bg-indigo-100/60 blur-3xl" />

        <div className="relative mx-auto max-w-7xl px-5 py-10 sm:px-8 sm:py-16 lg:py-20">
          <Link
            href="/"
            className="mb-10 inline-flex items-center gap-2 text-sm font-medium text-slate-500 transition hover:text-blue-600"
          >
          ...
          <div className="grid gap-12 lg:grid-cols-[0.9fr_1.1fr] lg:items-start">
            ...
            <div className="lg:sticky lg:top-28">
              ...
              <p className="mt-6 max-w-xl text-base leading-8 text-slate-600">
                Tell us a little about yourself. Our academy team will
                contact you with suitable programs, batch timings and
              ...
              <div className="mt-10 rounded-2xl border border-blue-100 bg-blue-50/70 p-5">
                ...
                <div className="mt-4 space-y-3">
                  {[
                    ...
                    "You receive suitable batch and plan information",
                  ].map((item, index) => (
                    <div
                      key={item}
              ...
              {!submitted ? (
                <>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <button
                      ...
                      className="inline-flex w-full items-center justify-center gap-2 rounded-xl bg-blue-600 px-5 py-4 text-sm font-semibold text-white shadow-lg shadow-blue-600/20 transition hover:bg-blue-700 disabled:cursor-not-allowed disabled:opacity-60"
                    >
                      {isSubmitting ? (
                        <>
                    ...
                    <p className="text-center text-xs leading-5 text-slate-500">
                      ...
                      the academy team regarding training and admission.
                    </p>
                  </form>
                </>
              ) : (
                <div className="py-8 text-center">
                  ...
                  <button
                    ...
                    className="mt-8 inline-flex items-center gap-2 rounded-xl border border-slate-200 px-5 py-3 text-sm font-semibold text-slate-700 transition hover:border-blue-200 hover:bg-blue-50 hover:text-blue-700"
                  >
          ...
          {isLoadingPlans ? (
            ...
            <div className="mt-12 grid gap-6 md:grid-cols-2 lg:grid-cols-3">
              {plans.map((plan) => (
                <div
                  key={plan._id}
                  className="flex flex-col rounded-3xl border border-slate-200 bg-white p-6 shadow-sm transition hover:-translate-y-1 hover:shadow-xl sm:p-8"
                >
                  ...
                  <a
                    href="#top"
                    className="mt-8 inline-flex items-center justify-center gap-2 rounded-xl border border-blue-200 bg-blue-50 px-4 py-3 text-sm font-semibold text-blue-700 transition hover:bg-blue-100"
                  >
      ...
      <section className="bg-blue-600">
        <div className="mx-auto max-w-4xl px-5 py-16 text-center sm:px-8 lg:py-20">
          ...
          <a
            href="#top"
            className="mt-8 inline-flex items-center gap-2 rounded-xl bg-white px-6 py-3.5 text-sm font-semibold text-blue-700 transition hover:bg-blue-50"
          >
            Submit an Enquiry
            <ArrowRight className="h-4 w-4" />
          </a>
